...
class RouteHunterApp:
    ...
    def from_data_dir(
        ...
        store.set_n_predicted_targets(_count_predicted_targets(str(base / monitor_subdir)))
    ...
    def monitor(self, year_min: Optional[int] = None, year_max: Optional[int] = None) -> MonitorResult:
        ...
        return _load_monitor(self.monitor_dir, year_min=year_min, year_max=year_max)
