...
paper_dois -- Hunter candidates are never written into the dataset,
so there is nothing to filter out here; every row exported comes from
the static CSV.
"""
    ...
    for target in store.all_targets():
        for doi in target.paper_dois:
            ...
            rows.append({
                ...
                "hunter_score": paper.hunter_score,
            })
